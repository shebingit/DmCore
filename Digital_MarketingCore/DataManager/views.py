...
def DAM_dataBank(request):
    if 'emp_id' in request.session:
        ...
        data_leads = DataBank.objects.filter(lead_Id__lead_collect_Emp_id__emp_comp_id__id=dash_details.emp_comp_id.id).order_by('Genarated_date')
